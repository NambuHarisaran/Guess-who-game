/**
 * Stage Guess Reveal Game - Admin Dashboard Controller (Hugo Extended Client-Side)
...
async function loadDashboardStats() {
    try {
        const games = await window.GameStore.getAllGames();
        ...
        if (games.length > 0) {
            const sorted = [...games].sort((a, b) => new Date(b.createdAt || 0) - new Date(a.createdAt || 0));
